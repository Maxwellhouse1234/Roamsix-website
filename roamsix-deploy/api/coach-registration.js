                ...
                <div style="max-width: 600px; margin: 0 auto; padding: 40px 20px;">
                  ...
                  <div style="background-color: #111827; border-radius: 8px; padding: 40px;">
                    ...
                    <div style="margin-bottom: 20px;">
                      ...
                      <p style="color: #9ca3af; font-size: 14px; margin: 0;">They'll complete their registration at: <a href="https://roamsix.com/proving-grounds/athlete-register" style="color: #c6a463;">roamsix.com/proving-grounds/athlete-register</a></p>
                    </div>
