...
const submitApplication = async (formData, pathway, invitationCode, email) => {
  try {
    const response = await fetch('/api/submit-application', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({ formData, pathway, invitationCode, email }),
    });
...
export default function RoamsixPrototype() {
  ...
  const termsContent = (
    ...
    >
      <h3
        className="text-xl text-gray-200 font-light mb-4"
      ...
      <div>
        ...
        <p>
          Roamsix experiences are available exclusively by invitation. Your invitation
          code grants you access to apply, not guaranteed participation. Final acceptance
          is at the sole discretion of Roamsix founders.
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          By submitting an application, you agree to provide accurate information. False
          or misleading information may result in immediate disqualification. We review
          all applications within 72 hours.
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          Accepted participants must be physically capable of outdoor activities and
          agree to follow all safety protocols. You are responsible for disclosing any
      ...
      <div>
        ...
        <p>
          Pricing is disclosed during the founder conversation. Full payment is required
          to secure your spot. Payments are non-refundable within 14 days of the
      ...
      <div>
        ...
        <p>
          Cancellations more than 30 days before: full refund minus $250 processing fee.
          15-30 days: 50% refund. Less than 14 days: no refund. Roamsix may cancel for
          weather, safety, or insufficient enrollment with full refunds.
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          Participation involves physical activity in outdoor environments. You assume
          all risk. Roamsix is not liable for injuries, loss, or damages except in cases
          of gross negligence.
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          Conversations and activities within cohorts are confidential. Participants
          agree not to share personal information or discussions without explicit
          consent.
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          We maintain a respectful, inclusive environment. Harassment, discrimination, or
          disruptive behavior will result in immediate removal without refund.
        </p>
      </div>
    </div>
  );
  ...
  const privacyContent = (
    ...
    >
      ...
      <div>
        ...
        <p>
          We collect: name, email, phone, location, LinkedIn profile, mailing address,
          professional information, and your written responses to application questions.
          For corporate/team applications, we also collect organization details.
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          Your information is used to: evaluate your application, communicate about your
          cohort, send acceptance letters, match you with appropriate experiences, and
          improve our programs. With your consent, we may contact you about alternative
          offerings.
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          We store your data securely using industry-standard encryption. Information is
          retained for up to 2 years after your last interaction with Roamsix. Accepted
          participants' records are kept for 5 years for program continuity.
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          We do not sell your data. We may share information with: payment processors (for
          transactions), insurance providers (for participant coverage), and emergency
          contacts (if provided). We will never share your application responses publicly.
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          If you opt in to receive information about alternative offerings, we will email
          you about relevant programs. You can unsubscribe anytime. We send no more than
          2 emails per month.
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          ...
          information (except where required for legal/safety reasons), opt out of
          marketing, and receive a copy of your data. Contact us to exercise these rights.
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          This website uses minimal tracking for basic analytics (page views, application
          completion rates). We do not use third-party advertising cookies.
        </p>
      </div>
      ...
      <div className="min-h-screen bg-black text-white relative overflow-hidden">
        ...
        <div className="relative min-h-screen flex flex-col items-center justify-center px-6">
          <div className="mb-16 animate-fadeIn">
            <h1
              className="text-6xl md:text-8xl font-light tracking-[0.3em] text-gray-200 mb-4"
              style={{ fontFamily: 'Cormorant Garamond, serif' }}
            >
              ROAMSIX
            </h1>
          ...
          <div className="max-w-md text-center mb-12 animate-fadeIn" style={{ animationDelay: '0.3s' }}>
            ...
            <p
              className="text-sm tracking-[0.15em] text-gray-300 opacity-70 uppercase mb-4"
      ...
      <div className="min-h-screen bg-black text-white relative overflow-hidden">
        ...
        <div className="relative min-h-screen flex flex-col items-center justify-center px-6">
          <div className="mb-12 text-center animate-fadeIn">
            <h2
              className="text-5xl md:text-6xl font-light tracking-[0.2em] text-gray-200 mb-6"
              style={{ fontFamily: 'Cormorant Garamond, serif' }}
            >
              You're In
            </h2>
      ...
      <div className="min-h-screen bg-black text-white relative overflow-hidden">
        ...
        <div className="relative min-h-screen px-6 py-12">
          <div className="max-w-6xl mx-auto mb-20 animate-fadeIn">
            <h2
              className="text-5xl md:text-7xl font-light tracking-[0.2em] text-gray-200 mb-6"
              style={{ fontFamily: 'Cormorant Garamond, serif' }}
            >
              Which Fits
            </h2>
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <h3
                      className="text-3xl font-light tracking-[0.15em] text-gray-200 mb-3 group-hover:tracking-[0.2em] transition-all duration-500"
                      style={{ fontFamily: 'Cormorant Garamond, serif' }}
                    >
                      {pathway.title}
                    </h3>
      ...
      <div className="min-h-screen bg-black text-white relative overflow-hidden">
        ...
        <div className="relative min-h-screen flex flex-col items-center justify-center px-6 py-12">
          <div className="max-w-2xl text-center animate-fadeIn">
            <h1
              className="text-6xl md:text-7xl font-light tracking-[0.25em] text-gray-200 mb-8"
              style={{ fontFamily: 'Cormorant Garamond, serif' }}
            >
              Under Review
            </h1>
            ...
            <div className="bg-gray-900 border border-gray-700 p-6 mb-12 text-left">
              <p className="text-xs text-gray-400 leading-relaxed" style={{ fontFamily: 'Crimson Text, serif' }}>
                ...
                <button onClick={() => setShowModal('terms')} className="text-gray-300 underline hover:text-white transition-colors">
                  Terms & Conditions
                </button>{' '}
                and{' '}
                <button onClick={() => setShowModal('privacy')} className="text-gray-300 underline hover:text-white transition-colors">
                  Privacy Policy
                </button>
            ...
            <div className="bg-gray-900 border border-gray-700 p-8 md:p-10 text-left">
              <p className="text-sm tracking-[0.15em] text-gray-400 uppercase mb-4 text-center">Next Steps</p>
              <p className="text-sm text-gray-400 mb-2 text-center" style={{ fontFamily: 'Crimson Text, serif' }}>
                We’ll follow up based on your application and any additional formats you selected.
              </p>
              {formData.alternativeInterests.length > 0 && (
                <div className="mt-6 p-4 bg-gray-800 border border-gray-600">
                  <p className="text-xs text-gray-400 mb-2">
                    <strong>Noted interests:</strong>
                  </p>
                  <ul className="text-sm text-gray-300 list-disc pl-5">
                    {formData.alternativeInterests.map((x) => (
                      <li key={x}>{x}</li>
                    ))}
                  </ul>
                </div>
      ...
      <div className="relative min-h-screen flex flex-col items-center justify-center px-6 py-12">
        ...
        {!showForm ? (
          <div className="max-w-3xl text-center animate-fadeIn">
            <h1
              className="text-6xl md:text-8xl font-light tracking-[0.25em] text-gray-200 mb-8"
              style={{ fontFamily: 'Cormorant Garamond, serif' }}
            >
            ...
            <div className="bg-gray-900 border border-gray-700 p-8 md:p-12 mb-12">
              ...
              <p className="text-sm text-gray-500">
                Limited to{' '}
                {selectedPath === 'Corporate' || selectedPath === 'Family'
                  ? '12-24 participants'
                  : selectedPath === 'Athletics'
                  ? '15-20 participants'
                  : '8-12 participants'}
                . Spots fill through referrals.
              </p>
            </div>
            ...
            <p className="mt-8 text-xs text-gray-600 tracking-wide">A founder will reach out within 48 hours to discuss fit and answer questions.</p>
          </div>
        ) : (
          <div className="max-w-2xl w-full animate-fadeIn">
            <div className="mb-12 text-center">
              <h2
                className="text-4xl md:text-5xl font-light tracking-[0.2em] text-gray-200 mb-4"
                style={{ fontFamily: 'Cormorant Garamond, serif' }}
              >
                Tell Us More
              </h2>
            ...
            <form onSubmit={handleFormSubmit} className="space-y-6">
              ...
              {/* Alternative Interests (moved here, BEFORE submission) */}
              <div className="border-t border-gray-800 pt-6 space-y-4">
                <p className="text-xs text-gray-400 tracking-wide uppercase">
                  If the 3-day format is tight right now, what else would you want info on
                </p>

                <div className="space-y-3">
                  {[
                    { id: '1-Day Workshop', label: '1-Day Workshops', description: 'Lower investment, single focus areas' },
                    { id: '2-Day Intensive', label: '2-Day Intensives', description: 'Weekend format for deeper work' },
                    { id: 'Custom Event', label: 'Custom Event for My Organization', description: 'Tailored experiences for teams' },
                    { id: 'Speaker Series', label: 'Speaker Series / Group Discussions', description: 'Ongoing community engagement' },
                    { id: 'Waitlist', label: 'Waitlist for Future Cohorts', description: 'Be notified when new dates open' },
                  ].map((interest) => (
                    <button
                      type="button"
                      key={interest.id}
                    ...
                    >
                      <div className="flex items-start gap-3">
                        <div
                          className={`w-4 h-4 border-2 flex-shrink-0 mt-0.5 transition-all ${
                            formData.alternativeInterests.includes(interest.id)
                ...
                <p className="text-xs text-gray-600" style={{ fontFamily: 'Crimson Text, serif' }}>
                  Optional. If selected, we will include it when we follow up.
                </p>
              </div>
