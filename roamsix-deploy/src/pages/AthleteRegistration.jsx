...
export default function AthleteRegistration() {
  ...
  const [step, setStep] = useState('teamCode'); // teamCode, form, waiver, complete
  ...
  // STEP 1: Team Code Entry
  if (step === 'teamCode') {
    return (
      <div style={{ minHeight: '100vh', backgroundColor: '#0a1628', color: '#f5f3f0', padding: '80px 20px' }}>
        <div style={{ maxWidth: '600px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '48px' }}>
            <h1 style={{ fontSize: '48px', fontWeight: 'bold', color: '#f5f3f0', margin: '0 0 16px 0', fontFamily: 'Montserrat, sans-serif' }}>
              Athlete Registration
            </h1>
            <p style={{ fontSize: '20px', color: '#5eead4', fontFamily: 'Inter, sans-serif' }}>
              ROAMSIX Proving Grounds
            </p>
            <p style={{ fontSize: '18px', color: '#cbd5e1', marginTop: '16px', fontFamily: 'Inter, sans-serif' }}>
          ...
          <div style={{ backgroundColor: '#152238', borderRadius: '12px', padding: '48px' }}>
            <div style={{ marginBottom: '24px' }}>
              <label style={{ display: 'block', fontSize: '16px', fontWeight: 'bold', color: '#f5f3f0', marginBottom: '8px', fontFamily: 'Inter, sans-serif' }}>
                Team Code
              </label>
              <input
                type="text"
            ...
            <button
              ...
              style={{
                width: '100%',
                backgroundColor: validatingCode ? '#64748b' : '#d4af37',
                color: '#0a1628',
                border: 'none',
                padding: '18px',
                fontSize: '18px',
      ...
      <div style={{ minHeight: '100vh', backgroundColor: '#0a1628', color: '#f5f3f0', padding: '80px 20px' }}>
        <div style={{ maxWidth: '700px', margin: '0 auto' }}>
          <div style={{ textAlign: 'center', marginBottom: '48px' }}>
            ...
            <p style={{ fontSize: '18px', color: '#5eead4', fontFamily: 'Inter, sans-serif' }}>
    ...
    return (
      <div style={{ minHeight: '100vh', backgroundColor: '#0a1628', color: '#f5f3f0', padding: '80px 20px' }}>
        <div style={{ maxWidth: '900px', margin: '0 auto' }}>
          ...
          {/* LIABILITY WAIVER */}
          <div style={{ backgroundColor: '#152238', borderRadius: '12px', padding: '40px', marginBottom: '24px', maxHeight: '400px', overflowY: 'scroll', border: '2px solid #1e293b' }}>
            <h2 style={{ fontSize: '24px', fontWeight: 'bold', color: '#d4af37', marginBottom: '24px', fontFamily: 'Montserrat, sans-serif' }}>
              Participant Liability Waiver & Assumption of Risk
            </h2>
            
            <div style={{ color: '#cbd5e1', lineHeight: '1.8', fontSize: '14px', fontFamily: 'Inter, sans-serif' }}>
              <p style={{ marginBottom: '16px', fontWeight: 'bold', color: '#f5f3f0' }}>
              ...
              <h3 style={{ fontSize: '16px', fontWeight: 'bold', color: '#5eead4', marginTop: '24px', marginBottom: '12px' }}>EVENT ACTIVITIES & RISKS</h3>
              ...
              <h3 style={{ fontSize: '16px', fontWeight: 'bold', color: '#5eead4', marginTop: '24px', marginBottom: '12px' }}>ASSUMPTION OF RISK</h3>
              <p style={{ marginBottom: '16px' }}>
              ...
              <h3 style={{ fontSize: '16px', fontWeight: 'bold', color: '#5eead4', marginTop: '24px', marginBottom: '12px' }}>RELEASE OF LIABILITY</h3>
              <p style={{ marginBottom: '16px' }}>
              ...
              <h3 style={{ fontSize: '16px', fontWeight: 'bold', color: '#5eead4', marginTop: '24px', marginBottom: '12px' }}>CONDUCT REQUIREMENTS</h3>
              <p style={{ marginBottom: '16px' }}>
          ...
          {/* MEDIA RELEASE */}
          <div style={{ backgroundColor: '#152238', borderRadius: '12px', padding: '40px', marginBottom: '32px', maxHeight: '400px', overflowY: 'scroll', border: '2px solid #1e293b' }}>
            <h2 style={{ fontSize: '24px', fontWeight: 'bold', color: '#d4af37', marginBottom: '24px', fontFamily: 'Montserrat, sans-serif' }}>
            ...
            <div style={{ color: '#cbd5e1', lineHeight: '1.8', fontSize: '14px', fontFamily: 'Inter, sans-serif' }}>
              ...
              <h3 style={{ fontSize: '16px', fontWeight: 'bold', color: '#5eead4', marginTop: '24px', marginBottom: '12px' }}>GRANT OF RIGHTS</h3>
              ...
              <h3 style={{ fontSize: '16px', fontWeight: 'bold', color: '#5eead4', marginTop: '24px', marginBottom: '12px' }}>WAIVER OF APPROVAL</h3>
              <p style={{ marginBottom: '16px' }}>
              ...
              <p style={{ marginBottom: '16px', fontSize: '12px', color: '#94a3b8' }}>
          ...
          <div style={{ backgroundColor: '#152238', borderRadius: '12px', padding: '40px', marginBottom: '32px' }}>
            <div style={{ marginBottom: '24px' }}>
              <label style={{ display: 'flex', alignItems: 'flex-start', cursor: 'pointer', fontFamily: 'Inter, sans-serif' }}>
                ...
                />
                <span style={{ color: '#f5f3f0', fontSize: '16px', lineHeight: '1.6' }}>
            ...
            <button
              ...
              style={{
                width: '100%',
                backgroundColor: (!waiverAccepted || !mediaReleaseAccepted || isSubmitting) ? '#64748b' : '#d4af37',
                color: '#0a1628',
                border: 'none',
                padding: '20px',
                fontSize: '18px',
          ...
          <p style={{ textAlign: 'center', color: '#94a3b8', fontSize: '14px', fontFamily: 'Inter, sans-serif' }}>
...
<div style={{ width: '80px', height: '80px', borderRadius: '50%', backgroundColor: '#d4af37', display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '32px' }}>          <span style={{ fontSize: '48px' }}>✓</span>
        ...
        <p style={{ fontSize: '20px', color: '#5eead4', marginBottom: '32px', fontFamily: 'Inter, sans-serif' }}>
          Welcome to Team {teamCode}
        </p>

        <div style={{ backgroundColor: '#152238', borderRadius: '12px', padding: '40px', marginBottom: '32px' }}>
          <p style={{ fontSize: '18px', color: '#cbd5e1', lineHeight: '1.8', fontFamily: 'Inter, sans-serif' }}>
        ...
        <div style={{ backgroundColor: '#152238', borderRadius: '12px', padding: '40px' }}>
          <h2 style={{ fontSize: '24px', fontWeight: 'bold', color: '#d4af37', marginBottom: '24px', fontFamily: 'Montserrat, sans-serif' }}>
            What's Next
          </h2>
          
          <div style={{ textAlign: 'left', color: '#cbd5e1', fontSize: '16px', lineHeight: '1.8', fontFamily: 'Inter, sans-serif' }}>
            <p style={{ marginBottom: '16px' }}>
              <strong style={{ color: '#f5f3f0' }}>May 17, 2026</strong><br />
              Chihuahua Valley, CA
            </p>
            <p style={{ marginBottom: '16px' }}>
