...
export default function OrganizationsPage() {
  ...
  return <SiteLayout>
    <section className="page-hero organization-hero"><div className="container narrow"><p className="eyebrow">For organizations</p><h1>Build a healthier team that can perform at a higher level for longer.</h1><p className="page-lead">ROAMSIX creates private experiences around the health, performance, and team outcomes your people need.</p><div className="button-row"><BookCallButton className="button button-accent">Discuss your team</BookCallButton><a className="text-link" href={emailHref}>Send an email <span aria-hidden="true">→</span></a></div></div></section>
