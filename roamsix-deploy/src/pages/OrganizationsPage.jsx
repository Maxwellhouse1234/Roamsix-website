...
export default function OrganizationsPage() {
  ...
  return (
    <SiteLayout>
      <section className="page-hero"><div className="container narrow"><p className="eyebrow">For organizations</p><h1>Give your people a deeper way to learn.</h1><p className="page-lead">ROAMSIX designs hands-on retreats and learning experiences that bring expert guidance and emerging science to life through distinctive places, practical activities, shared meals, and meaningful conversation. Your team can take part in an existing ROAMSIX experience, or work with us to shape one around a specific need.</p></div></section>
      <section className="section light-section"><div className="container organization-options">
        ...
        <article><p className="eyebrow">Create something for your organization</p><h2>Shape an experience around your needs.</h2><p>ROAMSIX can design a private retreat or experience around a subject your people need to understand more deeply. We bring together the right experts, emerging science, practical activities, distinctive places, and shared journey for that question.</p><div className="choice-links"><BookCallButton className="text-link">Let’s connect <span aria-hidden="true">→</span></BookCallButton><a className="text-link" href={emailHref}>Send a quick email <span aria-hidden="true">→</span></a></div></article>
      </div></section>
