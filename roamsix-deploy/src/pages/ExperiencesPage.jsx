    ...
    <SiteLayout>
      <section className="page-hero">
        <div className="container narrow">
          ...
          <p className="page-lead">Join us for a dinner, go deeper at an immersive retreat, or follow the subjects we are developing for 2027.</p>
        </div>
      </section>
      ...
      <section className="section light-section">
        <div className="container organization-options">
          ...
          <article>
            ...
            <p>An immersive retreat for health, wellness, fitness, food, and human-performance professionals, following the microbiome from soil and food into movement, focus, and recovery.</p>
