...
export default function OliveGroveDinnerPage() {
  ...
  const [form, setForm] = useState({ name: '', guestName: '', email: '', phone: '', emergencyName: '', emergencyPhone: '', dietaryNotes: '', guestDietaryNotes: '' });
    ...
    try {
      const response = await fetch('/api/create-checkout-session', {
        ...
        body: JSON.stringify({
          ...
          phone: form.phone.trim(), emergencyContactName: form.emergencyName.trim(),
          emergencyContactPhone: form.emergencyPhone.trim(), eventName: EVENT.name,
  ...
  return (
    <SiteLayout theme="dark">
      ...
      <section className="section fog-section"><div className="container dinner-included"><div><p className="eyebrow">What’s included</p><h2>One evening, fully hosted.</h2></div><ul><li>Guided garden tour with Robert</li><li>Farm-to-table dinner by Chef Kaci</li><li>Family-style meal in the olive groves</li><li>The full ROAMSIX evening at Father’s Farmhouse</li></ul></div></section>
